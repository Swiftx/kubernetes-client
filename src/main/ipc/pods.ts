...
export const create = async (_: IpcMainInvokeEvent, namespace: string, body: V1Pod) => {
...
export const replace = (_: IpcMainInvokeEvent, namespace: string, name: string, body: V1Pod) => {
