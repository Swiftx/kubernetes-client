...
export const create = async (_: IpcMainInvokeEvent, body: V1PersistentVolume) => {
...
export const replace = async (_: IpcMainInvokeEvent, name: string, body: V1PersistentVolume) => {
