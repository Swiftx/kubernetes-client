...
export const create = async (_: IpcMainInvokeEvent, namespace: string, body: V1Job) => {
...
export const replace = (_: IpcMainInvokeEvent, namespace: string, name: string, body: V1Job) => {
