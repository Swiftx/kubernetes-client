...
export const create = async (_: IpcMainInvokeEvent, namespace: string, body: V1Role) => {
...
export const replace = (_: IpcMainInvokeEvent, namespace: string, name: string, body: V1Role) => {
