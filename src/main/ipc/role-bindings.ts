...
export const create = async (_: IpcMainInvokeEvent, namespace: string, body: V1RoleBinding) => {
...
export const replace = (namespace: string, name: string, body: V1RoleBinding) => {
