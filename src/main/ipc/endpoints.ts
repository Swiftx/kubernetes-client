...
export const create = async (_: IpcMainInvokeEvent, namespace: string, body: V1Endpoints) => {
...
export const remove = async (_: IpcMainInvokeEvent, namespace: string, name: string) => {
